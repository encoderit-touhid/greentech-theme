...
if ( ! function_exists( 'greentech_posted_on' ) ) :
	/**
...
if ( ! function_exists( 'greentech_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'greentech_entry_footer' ) ) :
	/**
...
if ( ! function_exists( 'greentech_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function greentech_post_thumbnail() {
